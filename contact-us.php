<?php
$pageTitle = 'BRIDGE — Contact Us';
$activePage = 'contact';
?>
<?php include 'inc/header.php'; ?>

<main class="contact-page inner-page-top">
                        ...
                        <div class="contact__stage">
                            <div class="contact__info revealmetop">
                                <div class="contact__intro">
                                    <h1 class="contact__title contact-page__title title-animation">We're here<br>to
                                        help.</h1>
                                    <p class="contact__description title-animation">Whether you have questions about our
                                        services, want to explore partnership opportunities, or need expert guidance,

...
<main>
        ...
        <section class="hero" id="home">
            <div class="hero__video-wrap">
                <iframe
                    src="https://player.vimeo.com/video/1186158251?background=1&autoplay=1&muted=1&loop=1&quality=auto"
                    frameborder="0" allow="autoplay; fullscreen" allowfullscreen title="Hero background video"></iframe>
            </div>
            <div class="hero__overlay" aria-hidden="true"></div>
            <div class="hero__content">
                <h1 class="hero__title">
                    <span class="revealmetop" style="--reveal-delay: 0.1s">INNOVATE<span
                            class="hero__dot">.</span></span>
                    <span class="revealmetop" style="--reveal-delay: 0.22s">TRANSFORM<span
                            class="hero__dot">.</span></span>
                    <span class="revealmetop" style="--reveal-delay: 0.34s">ELEVATE<span
                            class="hero__dot">.</span></span>
                </h1>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="achievements__grid achievements__grid--three">
                            <article class="achievements__card revealmetop">
                                ...
                                <div class="achievements__value achievements__value--plus">
                                    <span class="odometer achievements__odometer" data-target="57"
                                        data-format="d">0</span>
                                </div>
                            </article>

                            <article class="achievements__card revealmetop" style="--reveal-delay: 0.08s">
                                <h3 class="achievements__label title-animation">Interactive simulations and games</h3>
                                <div class="achievements__value">
                                    <span class="odometer achievements__odometer" data-target="25"
                                        data-format="d">0</span>
                                </div>
                            </article>

                            <article class="achievements__card revealmetop" style="--reveal-delay: 0.16s">
                                <h3 class="achievements__label title-animation">Global certifications</h3>
                                <div class="achievements__value">
                                    <span class="odometer achievements__odometer" data-target="7"
                                        data-format="d">0</span>
                                </div>
                            </article>
                        </div>
                        ...
                        <div class="achievements__grid achievements__grid--two">
                            <article class="achievements__card revealmetop" style="--reveal-delay: 0.24s">
                            ...
                            <article class="achievements__card revealmetop" style="--reveal-delay: 0.32s">
                                ...
                                <div class="achievements__value achievements__value--suffix">
                                    <span class="odometer achievements__odometer" data-target="95"
                                        data-format="d">0</span>
                        ...
                        <div class="news__list">
                            ...
                            <article class="news__item" data-news-item>
                                ...
                                <div class="news__grid">
                                    ...
                                    <a class="news__media" href="#news"
                                        aria-label="Read ecosystem partnerships article">
                    ...
                    <div class="col-12">
                        ...
                        <div class="articles__grid">
                            <article class="articles__card" data-article-card>
                                <a class="articles__media" href="#articles"
                                    aria-label="Read smart manufacturing article">
                                    <img src="assets/images/article-1-image.webp"
                                        alt="Abstract grayscale folded surface">
                                </a>
                            ...
                            <article class="articles__card" data-article-card>
                                <a class="articles__media" href="#articles" aria-label="Read digital twins article">
                                    <img src="assets/images/article-2-image.webp"
                                        alt="Abstract dark circular line pattern">
                                </a>
                                <div class="articles__body">
                            ...
                            <article class="articles__card" data-article-card>
                                <a class="articles__media" href="#articles" aria-label="Read upskilling future article">
                                    <img src="assets/images/article-3-image.webp"
                                        alt="Abstract grayscale layered shapes">
                                </a>
                                <div class="articles__body">
                            ...
                            <article class="articles__card" data-article-card>
                                <a class="articles__media" href="#articles"
                                    aria-label="Read smart factory roadmap article">
